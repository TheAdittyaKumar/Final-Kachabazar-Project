...
--
-- Host: 127.0.0.1
-- Generation Time: May 15, 2025 at 04:08 AM
...
(1, 'Sprite', '', 'Beverages', 'Speeds up the process to diabetes. Recommended for heart patients.', 15.00, 180, 1),
(2, 'Carrot', '', 'Vegetables', 'Straight from Saint Martin. Fresh and healthy. ', 12.00, 65, 1),
(4, 'Burger Bun', '', 'Bakery', 'Made from 7 secret ingredients which guarantees you 4 kilograms of weight in 13 days.', 7.00, 250, 2),
(7, 'Milk Arong', '', 'Dairy', 'Healthy drink for everyone.', 10.00, 10, 2);
...
(6, '2025-05-15 06:51:45', 108.00, 'Completed', 2),
(8, '2025-05-15 07:21:45', 108.00, 'Completed', 1),
(9, '2025-05-15 07:22:00', 75.00, 'Completed', 1),
(10, '2025-05-15 07:30:06', 75.00, 'Pending', 1),
(11, '2025-05-15 07:36:58', 35.00, 'Completed', 1),
(12, '2025-05-15 07:51:43', 75.00, 'Completed', 1);
...
(1, 'Bajrangi Bhaijaan', 'Don no 1 groceries', 'seller@gmail.com', 'seller', '2025-05-14', 'Badda', 'Best or worst nothing in between. Order at your own risk. No refunds. Understood?'),
...
(1, 1, 0, 'Pewdiepie', '01746614671', 'admin', 'admin2@gmail.com'),
(2, 1, 0, 'Macho Man Randy Savage', '01746614671', 'admin', 'admin@gmail.com'),
